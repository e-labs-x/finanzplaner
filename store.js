...
function createDefaultStore() {
  ...
  return {
    ...
    persons: [
      {
        id:        'person_1',
        name:      'Enes',
        birthDate: '01.01.1976',   // Geburtsjahr 1976 — Tag/Monat ggf. anpassen
        isPrimary: true,
        isActive:  true,
        gender:    'm',
      },
    ...
    categories: [
      ...
      { id:'cat_sim_gps',       name:'SIM GPS Lamija',   parentId:null,       group:'fixkosten', color:'var(--cat-cyan)', hidden:false, sortOrder:20, source:'system' },
    ...
    recurring: [
      { id:'rec_hausgeld',    name:'Hausgeld / MIM Wohnung',    amount:284.78, type:'fixed',    categoryId:'cat_wohnung',     objectId:null,          personId:'person_1', validFrom:'01.2022', validUntil:null },
      { id:'rec_waerme',      name:'Wärme Mainova',             amount:208.00, type:'fixed',    categoryId:'cat_wohnung',     objectId:null,          personId:'person_1', validFrom:'01.2022', validUntil:null },
      ...
      { id:'rec_strom',       name:'Strom e.on',                amount:68.00,  type:'fixed',    categoryId:'cat_wohnung',     objectId:null,          personId:'person_1', validFrom:'01.2022', validUntil:null },
      { id:'rec_internet',    name:'Internet / TV Telekom',     amount:64.88,  type:'fixed',    categoryId:'cat_wohnung',     objectId:null,          personId:'person_1', validFrom:'01.2022', validUntil:null },
      { id:'rec_kfzvers',     name:'KFZ Versicherung ADAC',     amount:56.63,  type:'fixed',    categoryId:'cat_autoteile',   objectId:'obj_audi_a6', personId:'person_1', validFrom:'01.2022', validUntil:null },
      { id:'rec_kfzsteuer',   name:'KFZ Steuer',                amount:31.92,  type:'fixed',    categoryId:'cat_steuer',      objectId:'obj_audi_a6', personId:'person_1', validFrom:'01.2022', validUntil:null },
      ...
      { id:'rec_handy',       name:'Handyvertrag Enes',         amount:9.99,   type:'fixed',    categoryId:'cat_sonstiges',   objectId:null,          personId:'person_1', validFrom:'01.2022', validUntil:null },
      ...
      { id:'rec_schwimm',     name:'Schwimmkurs Lamija',        amount:111.57, type:'variable', categoryId:'cat_sonstiges',   objectId:null,          personId:'person_1', validFrom:'01.2022', validUntil:null },
      { id:'rec_tiefgarage',  name:'Tiefgarage',                amount:71.40,  type:'variable', categoryId:'cat_parken',      objectId:'obj_audi_a6', personId:'person_1', validFrom:'01.2022', validUntil:null },
      { id:'rec_rechtsschutz',name:'Rechtsschutz KS Auxilia',   amount:18.28,  type:'variable', categoryId:'cat_sonstiges',   objectId:null,          personId:'person_1', validFrom:'01.2022', validUntil:null },
      { id:'rec_rentenver',   name:'Rentenver. Dt. Herold',     amount:36.92,  type:'variable', categoryId:'cat_sonstiges',   objectId:null,          personId:'person_1', validFrom:'01.2022', validUntil:null },
      ...
      { id:'rec_rl_auto',     name:'Autokauf Rücklage',         amount:500.00, type:'savings',  categoryId:'cat_autoteile',   objectId:'obj_audi_a6', personId:'person_1', validFrom:'01.2022', validUntil:null },
      { id:'rec_rl_kfz',      name:'KFZ Wartung Rücklage',     amount:30.06,  type:'savings',  categoryId:'cat_autoteile',   objectId:'obj_audi_a6', personId:'person_1', validFrom:'01.2022', validUntil:null },
    ...
    assets: [
      ...
      {
        id:         'asset_etf_lamija',
        name:       'Vanguard All-World (Lamija)',
        type:       'etf',
        ownerId:    'joint',
        wkn:        'A2PKXG',
        isin:       '',
      ...
      {
        id:         'asset_immobilie',
        name:       'Eigentumswohnung Frankfurt',
        type:       'immobilie',
        ownerId:    'joint',
        wkn:        '',
        isin:       '',
        currency:   'EUR',
        snapshots:  [],
        meta:       { address:'', purchaseYear:'2020', purchasePrice:280000 },
        dataSource: 'manual',
        apiConfig:  null,
        status:     'aktiv',
      },
